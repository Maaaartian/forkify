...
// formatting the count of ingredients
const formatCount = count => {
    if (count) {
        // split the count into integer & decimal parts
...
export const updateServingsIngredients = recipe => {
    ...
    ingredientCounts.forEach((elem, i) => {
        elem.textContent = formatCount(recipe.ingredients[i].count)
    })
};